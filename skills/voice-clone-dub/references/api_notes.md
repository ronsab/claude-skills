...
1. **איכות S2S/TTS בעברית** -- נתמך רשמית אך פחות נבדק מאנגלית; ייתכנו ארטיפקטים בהגייה. בדוק קליפ קצר אחד לפני פרויקט מלא. **לזיהוי מקסימלי השתמש ב-PVC** (Professional Voice Clone): נוצר ב-Web UI של ElevenLabs, דורש Creator+ ואימות זהות + אימון, אך משפר דרמטית את הסיכוי שהקול יזוהה בבירור כרון. IVC הוא fallback מהיר בלבד. כמו כן S2S עדיף על TTS לזיהוי כי הוא שומר את התזמון והאינטונציה.
